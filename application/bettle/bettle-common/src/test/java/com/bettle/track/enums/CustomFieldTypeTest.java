...
public class CustomFieldTypeTest {
    ...
    public void toJson_fail() throws JsonProcessingException {
        ...
        objectMapper.writeValueAsString(CustomFieldType.values());
    }
    ...
    public void toJson_success() throws JsonProcessingException {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonValue = objectMapper.writeValueAsString(CustomFieldType.values());
