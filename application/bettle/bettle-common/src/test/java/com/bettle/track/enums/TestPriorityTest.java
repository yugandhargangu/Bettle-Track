...
/**
 * Test class of TestPriority.
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = TestConfiguration.class)
@AutoConfigureMockMvc
public class TestPriorityTest {
    ...
    public void toJson_fail() throws JsonProcessingException {
        ...
        objectMapper.writeValueAsString(TestPriority.values());
    }
    ...
    public void toJson_success() throws JsonProcessingException {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonValue = objectMapper.writeValueAsString(TestPriority.values());
