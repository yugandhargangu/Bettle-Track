...
/**
 * Test class of IssuePriority.
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = TestConfiguration.class)
@AutoConfigureMockMvc
public class IssuePriorityTest {
    ...
    public void toJson_fail() throws JsonProcessingException {
        ...
        objectMapper.writeValueAsString(IssuePriority.values());
    }
    ...
    public void toJson_success() throws JsonProcessingException {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        String jsonValue = objectMapper.writeValueAsString(IssuePriority.values());
